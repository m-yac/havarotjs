...
describe.each`
  ...
  ${"syllable with shureq"}       | ${"שׁוּרֶק"}        | ${0}        | ${"\u{FB35}"} | ${false}
...
describe.each`
  ...
  ${"syllable with shureq"}       | ${"שׁוּרֶק"}        | ${0}        | ${"SHUREQ"} | ${false}
  ${"syllable with none"}         | ${"test"}           | ${0}        | ${null}     | ${true}
...
describe.each`
  ...
  ${"syllable with shureq"}       | ${"שׁוּרֶק"}        | ${0}        | ${"SHUREQ"} | ${true}
  ${"syllable with vav dagesh"}   | ${"גֵּוּ"}           | ${0}        | ${"SHUREQ"} | ${false}
