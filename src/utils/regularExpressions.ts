export const taamim = /[\u{0591}-\u{05AF}\u{05BE}\u{05BF}\u{05C0}\u{05C3}-\u{05C6}\u{05F3}\u{05F4}]/u;
...
/**
 * a regular expression containing all the Hebrew point characters (excluding rafe)
 *
 * ```js
 * /[\u{05B0}-\u{05BB}\u{05C7}]/u;
 * ```
 */
export const vowelsWithSheva = /[\u{05B0}-\u{05BB}\u{05C7}]/u;
